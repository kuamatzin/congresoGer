...
document.addEventListener('DOMContentLoaded', function () {
	...
	function initMap() {
		var map = new google.maps.Map(document.getElementById('map'), {
			center: { lat: 23.140489, lng: -82.383851 },
			scrollwheel: true,
			zoom: 18,
			controls: []
		});
		var icon = 'img/ico2.png';
		var marker = new google.maps.Marker({
			position: { lat: 23.140489, lng: -82.383851 },
			title: 'Facultad de Economía de la Universidad de La Habana, Cuba',
			icon: icon,
			map: map
		});
	}
